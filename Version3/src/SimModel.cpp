...
//-----------------------------------------
// resets stats for new run of simulation
//-----------------------------------------
void SimModel::resetStats()
{
	crossCount = 0; //resets crossover counter to zero
	fill(&geneStats[0][0], &geneStats[0][0] + 10*3, 0); //resets 2D array to zero
}